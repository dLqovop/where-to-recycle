...
//
//        final Button mbuttonTest = findViewById(R.id.NextPage);
//        mbuttonTest.setOnClickListener(new View.OnClickListener(){
//            public void onClick(View v){
//                Intent intent_next = new Intent(getApplicationContext(), DetectedClassResult.class);
...
//                //mButtonDetect.setText(getString(R.string.run_model)); //왜인지 run_model을 못 가져옴
//                if(mBitmap!=null) {
...
//            //mButtonDetect.setText(getString(R.string.detect)); // 이것또한 detect 빨감 왜지?
